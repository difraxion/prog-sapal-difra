	...
	<div class="wrapper">	
		...
		<section data="content-general">
			<article data="directorio">
				...
				<div class="tar">
					<a class="lnk-back dib pr lnkup" href="{DIR}transparencia/leydetransparencia"><span class="pa db"></span>Regresar al Menú</a>
				</div>
				<section>
					{DIRECTORIO}
				</section>
				<div class="tar">
					<a class="lnk-back dib pr lnkbottom" href="{DIR}transparencia/leydetransparencia"><span class="pa db"></span>Regresar al Menú</a>
				</div>
			</article>
		</section>
